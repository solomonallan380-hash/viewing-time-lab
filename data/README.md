...
1. **Clean** — Import and apply functions from `cleaner.py` to prepare both groups' data for analysis.
2. **Explore** — Compute descriptive statistics and examine distributions programmatically. Compare control vs. treatment group metrics side by side.
3. **Report** — Present findings in plain language, supported by one effective data visualization that communicates whether the treatment had a meaningful impact on viewing time.

---

## Running the Project

1. Open `explore.ipynb` in Jupyter or VS Code.
2. Run all cells from top to bottom.
3. Findings and the visualization are rendered inline within the notebook.
